...
const data = JSON.parse(localStorage.getItem('acdata'));
var today = new Date();
...
function getdata(){
  axios
    ...
    .then( (deta) => {
      /*setData(deta.data.courses)*/
      localStorage.removeItem('acdata');
      localStorage.setItem('acdata', JSON.stringify(deta.data.courses));
    })
};
...
function Render(){
  if (tokenemailstudentuser) {
    if (data) {
        ...
        <div className="AllCourses">
            <div className="row g-0 justify-content-around">
               ...
               <div className="col-sm-12">
                  ...
                  <div className="row g-0 m-0 pb-4 justify-content-around">
                     {
                       data.map((data) => 
      ...
      </div><div class="row gy-3 gx-0  py-3 justify-content-around bg-light px-3">
        <div class="col-sm-3 bg-success d-flex justify-content-center p-5">
          <div class="spinner-border text-primary" role="status">
          <span class="visually-hidden">Loading...</span>
          </div>
                  ...
                  <div className="row g-0 m-0 pb-4 justify-content-around">
                     {
                      ...
                      <div class="col-sm-3 col-3 d-flex justify-content-start">
                       ...
                       <div class="col-sm-3 col-3 d-flex justify-content-end">
                      <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal1">Enroll</button>
                        </div>
                      </div>
                                 </form>
                              </div>
